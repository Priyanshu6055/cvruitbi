  ...
  corporate: [
    {
      ...
      logo: "/partners-logo/corporate-partners/nasscom.jpg",
    },
    {
      title: "Wadhwani Foundation",
      logo: "/partners-logo/corporate-partners/wadhwani.webp",
    },
    {
      title: "Sahabhagi Samaj Sevi Sanstha",
      logo: "/partners-logo/corporate-partners/sahabhagi.jpg",
    },
    {
      title: "SetMyCart",
      logo: "/partners-logo/corporate-partners/setmycart.png",
    },
    {
      title: "Headstart Chhattisagrh",
      logo: "/partners-logo/corporate-partners/headstart.jpg",
    },
    {
      title: "Real Time Angel Fund",
      logo: "/partners-logo/investment-partners/realtime.png",
    },
    {
      title: "Fluid Venture",
      logo: "/partners-logo/investment-partners/fluid.png",
    },
    {
      title: "Miaana Partners",
      logo: "/partners-logo/investment-partners/miaana.jpg",
    },
  ],
  investment: [],
};
    ...
    <>
      ...
      <section className="relative bg-gradient-to-b from-[#f8fdff] to-white text-[#0b1220] py-12 overflow-hidden">
        <div className="container-global px-4 md:px-10">
          ...
          <Section title="All Partners" data={partnersData.corporate} />
          {/* <Section title="Investment Partners" data={partnersData.corporate} /> */}
        </div>
