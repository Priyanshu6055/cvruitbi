...
export default function Button({
  ...
  return (
    <MotionElement
      ...
      whileTap={{ scale: 0.95 }}
      className={`relative group overflow-hidden px-7 py-3 rounded-xl font-semibold shadow-lg border bg-transparent text-[#00d2ef] border-[#00d2ef] transition-all duration-300 hover:text-white ${className}`}
      {...props}
    >
      {/* Rising Water Fill */}
      ...
      {/* Curved Waves */}
      <svg
        className="absolute bottom-0 left-0 right-0 w-full h-[120%] -z-10 translate-y-full group-hover:translate-y-0 transition-all duration-[900ms] ease-out"
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
      >
        <path
          fill="rgba(255,255,255,0.6)"
          d="M0,224L40,229.3C80,235,160,245,240,240C320,235,400,213,480,186.7C560,160,640,128,720,144C800,160,880,224,960,229.3C1040,235,1120,181,1200,176C1280,171,1360,213,1400,234.7L1440,256L1440,320L0,320Z"
        >
          <animate
            attributeName="d"
            dur="4s"
